@extends('index2')
    ...
    @section('content')
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Ingredientes<small> Listado</small></h1>
        <!-- end page-header -->
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Listado ingredientes</h4>
                    </div>
                    ...
                    <div class="panel-body">
                        <div class="alert alert-info fade in">
                            <i class="fa fa-info fa-2x pull-left"></i>
                            <p>Listado global de ingredientes.</p>
                        </div>
                            ...
                            <table id="data-table" class="table table-striped table-bordered">
                                <thead class="bg-orange-lighter">
                                    <tr>
                                        ...
                                        <th class="text-white"><small>FECHA DE ULTIMA ACTULIZACION</small></th>
                                    </tr>
                                </thead>
                                <tbody id="datos">
                                @foreach($ingredientes as $ingrediente)
                                    <tr class="gradeA">
                                        ...
                                        <td class="puesto">{{$ingrediente->categoria->nombre}}</td>
                                        <td class="telefono">{{$ingrediente->created_at->format('d/m/Y')}}</td>
                                        <td class="telefono">{{$ingrediente->updated_at->format('d/m/Y')}}</td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
