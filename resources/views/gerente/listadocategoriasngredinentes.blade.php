@extends('index2')
    ...
    @section('content')
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Categoria ingredientes<small> Listado</small></h1>
        <!-- end page-header -->
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Listado categorias</h4>
                    </div>
                    
                    <div class="panel-body">
                    <div class="alert alert-info fade in">
                            <i class="fa fa-info fa-2x pull-left"></i>
                            <p>Listado global de categorias de ingredientes!</p>
                        </div>
                            ...
                            <table id="data-table" class="table table-striped table-bordered">
                                ...
                                @foreach($categorias as $categoria)
                                    <tr class="gradeA">
                                        ...
                                        <td class="telefono">{{$categoria->created_at->format('d/m/Y')}}</td>
                                        <td class="telefono">{{$categoria->updated_at->format('d/m/Y')}}</td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
