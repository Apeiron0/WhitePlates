...
<!-- Mirrored from seantheme.com/color-admin-v1.6/admin/html/extra_404_error.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Feb 2015 04:16:21 GMT -->
<head>
	<meta charset="utf-8" />
        ...
        <div class="error">
            ...
            <div class="error-content">
                ...
                <div class="error-desc m-b-20">
                    La pagina que esta buscando no existe. <br />
                    
                </div>
                <div>
                    <a href="/usuario/login" class="btn btn-success">Regresar a página principal</a>
                </div>
            </div>
        </div>
        <!-- end error -->
