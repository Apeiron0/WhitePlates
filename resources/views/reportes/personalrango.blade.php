@extends('index2')
	...
	@section('content')
		...
		<ol class="breadcrumb pull-right">
			...
			<li class="active">Ganancias  meseros</li>
		</ol>
		<!-- end breadcrumb -->
		<!-- begin page-header -->
		<h1 class="page-header">Ganancias<small> Meseros</small></h1>
		<!-- end page-header -->
		...
		$(document).ready(function() {
            ...
            function loadchart(){
                $('#container').highcharts({
                    ...
                    subtitle: {
                        text: 'Total de ganancias por meseros'
                    },
                    plotOptions: {
                        column: {
                            depth: 25,
            ...
            function loadtable(){
                ...
                llamarajax(datos, "/reportes/totalgananciameseroocajero", "JSON").success(function(data){
                    console.log(data)
                ...
                No se encontraron datos del rango seleccionado.</p></div>');
                        ...
                        valores.push([parseFloat(val.Vendido)]);
